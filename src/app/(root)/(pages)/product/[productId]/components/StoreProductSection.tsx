    ...
    <div className="flex w-full flex-col lg:flex lg:w-[60%] lg:gap-5">
      ...
      {storeProduct ? (
        <div className="flex flex-col gap-6">
          <ProductBookingSection storeProduct={storeProduct} />
        </div>
      ) : (
        <div className="border-accent-custom mx-4 mt-2 flex items-center justify-center rounded-md border border-dashed bg-white p-2 shadow-sm">
